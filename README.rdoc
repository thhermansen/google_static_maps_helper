...
If you are on Rails (2.x) you can put it in your environment configuration file and while you are there you can add the following line inside the configuration block:
