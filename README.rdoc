...
parameter to the new method, or include it in the has where lng and lat is.
  GoogleStaticMapsHelper::Marker.new(location, :color => 'blue')
  GoogleStaticMapsHelper::Marker.new(:lng => 1, :lat => 2, :color => 'blue')
...
Another thing you might want to do is to override the center point and zoom level. This is done during map construction
  map = GoogleStaticMapsHelper::Map.new(:key => YOUR_GOOGLE_KEY, :sensor => false, :size => '200x300', :center => '1,2', :zoom => 4) 
